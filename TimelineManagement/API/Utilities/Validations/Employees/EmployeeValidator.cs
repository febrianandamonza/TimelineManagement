...
namespace TimelineManagement.Utilities.Validations.Employees;
...
public class EmployeeValidator : AbstractValidator<EmployeeDto>
{
    ...
    public EmployeeValidator(IEmployeeRepository employeeRepository)
    {
        ...
        RuleFor(e => e.Email)
            ...
            .EmailAddress().WithMessage("Email is mot valid").Must((e, s) => IsDuplicateValue(s, e.Guid)).WithMessage("Email already exist");


        RuleFor(e => e.PhoneNumber)
            .NotEmpty().WithMessage("Phone Number is required")
            .MaximumLength(20)
            .Matches(@"^\+[0-9]").Must((e, s) => IsDuplicateValue(s, e.Guid)).WithMessage("Phone Number already exist");
