...
namespace TimelineManagement.Migrations
{
    ...
    [Migration("20230821044555_ChangeNameInTask")]
    partial class ChangeNameInTask
    {
            ...
            modelBuilder.Entity("TimelineManagement.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 8, 21, 11, 45, 55, 399, DateTimeKind.Local).AddTicks(9482),
                            ModifiedDate = new DateTime(2023, 8, 21, 11, 45, 55, 399, DateTimeKind.Local).AddTicks(9493),
                            Name = "Staff"
                        },
                        new
                        {
                            Guid = new Guid("203b4a4b-e9f7-4419-e553-08db9fa3dda3"),
                            CreatedDate = new DateTime(2023, 8, 21, 11, 45, 55, 399, DateTimeKind.Local).AddTicks(9496),
                            ModifiedDate = new DateTime(2023, 8, 21, 11, 45, 55, 399, DateTimeKind.Local).AddTicks(9496),
