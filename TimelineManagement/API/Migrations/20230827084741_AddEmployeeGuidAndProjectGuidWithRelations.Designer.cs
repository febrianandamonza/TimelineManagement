...
namespace TimelineManagement.Migrations
{
    ...
    [Migration("20230827084741_AddEmployeeGuidAndProjectGuidWithRelations")]
    partial class AddEmployeeGuidAndProjectGuidWithRelations
    {
            ...
            modelBuilder.Entity("TimelineManagement.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 8, 27, 15, 47, 41, 444, DateTimeKind.Local).AddTicks(8741),
                            ModifiedDate = new DateTime(2023, 8, 27, 15, 47, 41, 444, DateTimeKind.Local).AddTicks(8754),
                            Name = "Staff"
                        },
                        new
                        {
                            Guid = new Guid("203b4a4b-e9f7-4419-e553-08db9fa3dda3"),
                            CreatedDate = new DateTime(2023, 8, 27, 15, 47, 41, 444, DateTimeKind.Local).AddTicks(8759),
                            ModifiedDate = new DateTime(2023, 8, 27, 15, 47, 41, 444, DateTimeKind.Local).AddTicks(8759),
