...
namespace TimelineManagement.Migrations
{
    ...
    [Migration("20230818090545_DefaultRoleSection")]
    partial class DefaultRoleSection
    {
            ...
            modelBuilder.Entity("TimelineManagement.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 8, 18, 16, 5, 44, 945, DateTimeKind.Local).AddTicks(773),
                            ModifiedDate = new DateTime(2023, 8, 18, 16, 5, 44, 945, DateTimeKind.Local).AddTicks(788),
                            Name = "Staff"
                        },
                        new
                        {
                            Guid = new Guid("203b4a4b-e9f7-4419-e553-08db9fa3dda3"),
                            CreatedDate = new DateTime(2023, 8, 18, 16, 5, 44, 945, DateTimeKind.Local).AddTicks(794),
                            ModifiedDate = new DateTime(2023, 8, 18, 16, 5, 44, 945, DateTimeKind.Local).AddTicks(795),
